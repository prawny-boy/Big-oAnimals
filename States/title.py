...
class TitleState(State):
    def __init__(self, game):
        super().__init__(game)
        self.buttons = {
            "login": Button(400, 200, 200, 50, "Login"),
            "signup": Button(400, 280, 200, 50, "Signup"),
            "anonymous": Button(400, 360, 200, 50, "Stay Anonymous"),
            "test": Button(400, 440, 200, 50, "Test (Admin)")
        }
